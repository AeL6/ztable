// javascript file version of the possible ztable values
// not using a json file because it needs to be hosted on a server for the fetch api to work
// doing this locally will not allow me to access this as a json file
let zTable = [
  [
    '0.0',
  ...
  [
    '0.7',
    [
      0.258, 0.2611, 0.2642, 0.2673, 0.2704, 0.2734, 0.2764, 0.2794, 0.2823,
      0.2852,
    ],
  ],
  [
  ...
  [
    '1.1',
    [
      0.3643, 0.3665, 0.3686, 0.3708, 0.3729, 0.3749, 0.377, 0.379, 0.381,
      0.383,
    ],
  ],
  [
  ...
  [
    '2.5',
    [
      0.4938, 0.494, 0.4941, 0.4943, 0.4945, 0.4946, 0.4948, 0.4949, 0.4951,
      0.4952,
    ],
  ],
  [
